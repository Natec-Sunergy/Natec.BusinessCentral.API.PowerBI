page 73151 "APIV1 - PTE Sales D.L.A. Ent."
{
    PageType = API;
    APIPublisher = 'natec';
    APIGroup = 'powerbi';
    APIVersion = 'v1.0';
    Caption = 'salesArchiveDocumentLines';
    EntityCaption = 'SalesArchiveDocumentLine';
    EntitySetCaption = 'SalesArchiveDocumentLines';
    EntityName = 'salesArchiveDocumentLine';
    EntitySetName = 'salesArchiveDocumentLines';
