page 73147 "PTE APIV1 - Purchase Header"
{
    ...
    layout
    {
        area(Content)
        {
            ...
            // field(printAmounts; Rec."Print Amounts") { }
            // field(ship-toPhoneNo  ; Rec."Ship-to Phone No.") { }
            // field(ship-toE - Mail   ; Rec."Ship-to E-Mail") { }
            // field(buy-fromPhoneNo ; Rec."Buy-from Phone No.") { }
            // field(buy-fromE - Mail  ; Rec."Buy-from E-Mail") { }
